...
def extract_face(face, source_images, output_dir, rng, target_size=128, supersampling=4, enable_padding=True, random_shift=0.0, retry_crops=False, rotate_level=True):
