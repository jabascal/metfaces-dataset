...
def extract_face(face, source_images, output_dir, rng, target_size=64, supersampling=4, enable_padding=True, random_shift=0.0, retry_crops=False, rotate_level=True):
